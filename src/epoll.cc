...
namespace libev {
  ...
  /************************************************************************/
  void EpollReactor::Impl::ResizeIOEvent(size_t fd)
  {
  ...
  void EpollReactor::Impl::UnInit()
  {
    ...
    if (epfd_ != -1)
    {
      if (signal_)
      {
        ...
        epoll_ctl(epfd_, EPOLL_CTL_DEL, signal_event_.data.fd, NULL);
      }
